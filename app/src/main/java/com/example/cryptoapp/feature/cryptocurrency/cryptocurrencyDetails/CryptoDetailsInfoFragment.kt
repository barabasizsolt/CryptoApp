...
class CryptoDetailsInfoFragment : Fragment() {
    ...
    private fun initUI() {
        ...
        cryptoCurrencyViewModel.getCryptoCurrencyDetails().observe(viewLifecycleOwner, currencyObserver)
    }

    private val currencyObserver =
        androidx.lifecycle.Observer<Response<CryptoCurrencyDetails>> { response ->
